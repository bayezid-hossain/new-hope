...
export const KpiCards = ({ totalBirds, totalFeedStock, lowStockCount, avgMortality, activeCyclesCount }: KpiCardsProps) => {
    return (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">{totalFeedStock.toFixed(1)} <span className="text-sm font-normal text-muted-foreground">bags</span></div>
                    <p className="text-xs text-muted-foreground">
                        Available in farmer stocks
                    </p>
                </CardContent>
            </Card>
