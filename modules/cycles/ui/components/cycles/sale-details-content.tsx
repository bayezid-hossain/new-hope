            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-x-2 sm:gap-x-4 gap-y-3 text-[13px] sm:text-sm">
                    <div className="space-y-3">
                        ...
                        {(!isLatest || !sale.cycleContext?.isEnded) && <div className="flex justify-between items-baseline">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3 px-1">
                        ...
                        {(!isLatest || !sale.cycleContext?.isEnded) && <div className="flex justify-between items-center group">
                            <div className="flex items-center gap-2">
                ...
                return (
                    <div className={cn(
                        ...
                        <FcrEpiDetailsModal
                            ...
                            doc={doc}
                            mortality={mortality}
                            birdsRejected={sale.cycleContext?.totalBirdsRejected ?? selectedReport?.birdsRejected ?? sale.birdsRejected ?? 0}
                            totalBirdsSold={sale.cycleContext?.cumulativeBirdsSold || 0}
